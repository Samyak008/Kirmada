...
@tool
async def generate_image_prompts(script_content: str, num_prompts: int = 5) -> str:
    """Generate AI image generation prompts based on script content using GPT-4o-mini."""
    try:
...
"""
        ...
        response = prompt_model.invoke([HumanMessage(content=llm_prompt)])
...
# Export tools
prompt_generation_tools = [generate_image_prompts, generate_shot_specific_prompts]