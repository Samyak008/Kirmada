...
# Initialize OpenAI GPT-4o-mini for search term extraction
search_term_model = ChatOpenAI(
    model="gpt-4o-mini",
...
async def search_broll_from_prompts(prompts_data: List[Dict[str, Any]]) -> str:
    ...
    try:
        ...
        for prompt_info in prompts_to_search:
            ...
            search_query = await _simplify_prompt_for_search(prompt_text)
...
async def _simplify_prompt_for_search(prompt_text: str) -> str:
    """
...
"""
        ...
        response = await search_term_model.ainvoke([
